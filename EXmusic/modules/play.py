...
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup, Message, Chat, CallbackQuery, ReplyKeyboardMarkup, KeyboardButtonCallback
...
async def p_cb(b, cb):
    ...
    if type_ == "playlist":
        ...
        msg = "💡 **Song currently playing** on {}".format(cb.message.chat.title)
        msg += "\n• " + now_playing
        msg += "\n• Req by " + by
        temp.pop(0)
        if temp:
